...
const registerParentSchema = yup.object().shape({
  nama: yup.string().required('Nama harus diisi'),
  email: yup.string().email('Email tidak valid').required('Email harus diisi'),
  no_hp: yup
    .string()
  ...
  jenis_kelamin: yup.string().required('Jenis kelamin harus diisi'),
  alamat: yup.string().required('Alamat harus diisi'),
  email_siswa: yup.string().email('Email tidak valid').required('Email siswa harus diisi'),
  password: yup.string().required('Password harus diisi'),
  confirm_password: yup
    .string()
    .oneOf([yup.ref('password'), null], 'Password tidak sama')
...
export const VALIDATION_SCHEMA = { registerSchema, loginSchema, registerParentSchema, registerStudentSchema };
