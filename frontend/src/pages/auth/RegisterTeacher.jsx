    ...
    return <BgAuth>
        <Box overflow={'auto'} bg={'white'} maxH={'80vh'} w={['90%', '50%']} m={'auto'} p={[4, 6, 10, 20]} borderRadius={['xl', '2xl']} boxShadow={['2xl']}>
            ...
            <form>
                ...
                <InputText name='password' label='Password' value={input.password} handleChange={handleChange} isRequired />

                <Flex justify={'center'} gap={[2]} mb={[2,4]}>
                    <Button size={['sm', 'md']}><Link to={'/register'}>Kembali</Link></Button>
